  ...
  return (
    <div className="min-h-screen pb-16 sm:pb-20 px-2 sm:px-4 md:px-6 pt-2 sm:pt-4">
      ...
      <div className="mb-4 sm:mb-6">
        <h3 className="text-base sm:text-xl font-bold text-white mb-3 sm:mb-4">Твои цели</h3>
          ...
          {favoriteSkins && favoriteSkins.length > 0 ? (
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center justify-between">
                <h4 className="text-white font-medium text-xs sm:text-base">Избранные предметы:</h4>
                <button 
      ...
      {/* Easy Coins Section */}
      <div className="mb-4 sm:mb-6">
        <h3 className="text-base sm:text-xl font-bold text-white mb-3 sm:mb-4">Легкие монеты</h3>
        <div className="grid grid-cols-3 gap-2 sm:gap-3">
          <div 
      ...
      <div className="mb-4 sm:mb-6">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          <h3 className="text-base sm:text-xl font-bold text-white">Задания</h3>
          <button 
